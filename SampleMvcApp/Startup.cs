        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, IOptions<Auth0Settings> auth0Settings)
        {
            ...
            var options = new OpenIdConnectOptions("Auth0")
            {
                ...
                Events = new OpenIdConnectEvents
                {
                    ...
                    {
                        if (context.Properties.Items.ContainsKey("audience")) 
                        {
                            context.ProtocolMessage.SetParameter("audience", context.Properties.Items["audience"]);
                        }

                        if (context.Properties.Items.ContainsKey("scope")) 
                        {
                            var scope = context.Properties.Items["scope"];
